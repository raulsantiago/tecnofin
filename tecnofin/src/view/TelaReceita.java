...
public class TelaReceita extends JFrame {
	...
	public TelaReceita() {
		...
		lblReceitas.setForeground(Color.GRAY);
		lblReceitas.setHorizontalTextPosition(SwingConstants.CENTER);
		lblReceitas.setHorizontalAlignment(SwingConstants.CENTER);
		lblReceitas.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblReceitas.setBounds(234, 20, 166, 26);
		contentPane.add(lblReceitas);
		
		JLabel lblContaContbil = new JLabel("CONTA CONT\u00C1BIL");
		lblContaContbil.setForeground(Color.GRAY);
		lblContaContbil.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblContaContbil.setBounds(84, 78, 111, 16);
		contentPane.add(lblContaContbil);
		
		JLabel lblNomeDaReceita = new JLabel("NOME DA RECEITA");
		lblNomeDaReceita.setForeground(Color.GRAY);
		lblNomeDaReceita.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNomeDaReceita.setBounds(247, 77, 114, 16);
		contentPane.add(lblNomeDaReceita);
		
		textContaReceita = new JTextField();
		textContaReceita.setBounds(80, 92, 150, 28);
		...
		btnSalvar.setBounds(83, 127, 95, 28);
